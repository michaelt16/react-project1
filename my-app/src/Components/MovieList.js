        ...
        <div className="w-3/4 p-4 bg-gray-200">
            ...
            <div className="grid grid-cols-6 gap-4 grid-rows-2 mt-6 mx-4">
                    ...
                    <div className="border  mb-2 rounded-xl shadow relative bg-gray-100 cursor-pointer">
                        ...
                        <h3 className="font-bold px-3 py-2 mb-2 overflow-hidden">Kungfu Panda (2012)</h3>
                        <div className="absolute bg-indigo-400 mb-2 text-white rounded-full bottom-8 right-0 text-center w-10 h-10 flex items-center justify-center">
