...
export default function Filter(){
    ...
    <select class="bg-white border border-gray-400 rounded p-2 mb-4 w-full">
    ...
    <input type="date" class="bg-white border border-gray-400 rounded p-2 mb-20 w-full" />
    <h3 className="text-md mb-2">Rating</h3>
    <input type="range" min="0" max="10" className="w-full mb-12" />
    <input type="submit" className="border p-4 px-8 mx-12 rounded-md bg-grey text-white cursor-pointer hover:bg-gray-600"></input>
    <input type="submit" value="Clear" className="border p-4 px-10 rounded-md bg-grey text-white cursor-pointer hover:bg-gray-600"></input>
</div>
)
}